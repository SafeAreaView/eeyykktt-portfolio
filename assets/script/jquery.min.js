...
var arrLang = {
  en: {
    ...
    portfolio: "Portfolio",
    contacts: "Contacts",
    name: "Ekaterina Sorokina",
    aboutText: `Hi, I'm Ekaterina – UX/UI designer from Odessa.
    I'm interested in design and everything connected with it.
    I'm studying at course "Web and mobile design
    interfaces".`,
    workAt: "I work in such programs as",
    contactsCase: `Want to know more or just chat?
    You are welcome!`,
    likeMe: `Like me on
    LinkedIn, Instagram, Behance, Telegram`,
  },
  ukr: {
    up: "Догори",
    home: "Головна",
    ...
    portfolio: "Портфоліо",
    contacts: "Контакти",
    name: "Катерина Сорокіна",
    aboutText: `Привіт, я Катерина - UX/UI дизайнер з Одеси.
    Я цікавлюся дизайном і всім, що з ним пов'язано.
    Я навчаюся на курсі "Веб-дизайн та дизайн мобільних
    інтерфейсів".`,
    workAt: "Я працюю в таких програмах як",
    contactsCase: `Хочете дізнатися більше або просто поспілкуватися?
    Будь ласка, ласкаво просимо!`,
    likeMe: `Підписуйтесь на мене в
    LinkedIn, Instagram, Behance, Telegram`,
  },
};
